    ...
    <div class="grid">
      ...
      <div class="col-12 md:col-6">
        <p-card>
          <ng-template pTemplate="header">
            <div class="p-3">
              <h3 class="m-0">Quick Test Payment</h3>
            </div>
          </ng-template>
        ...
        <p-card>
          ...
          <div class="flex flex-column gap-3">
            ...
            <div class="text-500 text-sm">
              <strong>Webhook URL for Stripe:</strong><br>
...
export class PaymentTestComponent implements OnInit {
  ...
  constructor(
    ...
    this.testPaymentForm = this.fb.group({
      ...
      description: ['Test payment for development', Validators.required]
    });
  }
  ...
  createTestPayment() {
    if (this.testPaymentForm.valid) {
      ...
      const paymentData = {
        ...
        contract_id: null // For testing, no contract required
      };
      ...
      this.paymentService.createQuickPayment(paymentData).subscribe({
        next: (response) => {
          this.messageService.add({
            severity: 'success',
            summary: 'Success',
            detail: `Test payment created: $${response.amount}`
          });
        ...
        error: (error) => {
          ...
          this.messageService.add({
            severity: 'error',
            summary: 'Error',
            detail: 'Failed to create test payment'
          });
          this.loading = false;
        }
      });
